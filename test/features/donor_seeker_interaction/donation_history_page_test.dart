...
import 'package:sharingbridge_mobile_app/presentation/donor_navigator_shell.dart';
...
void main() {
  ...
  testWidgets('home hub opens donation history and Home returns to hub',
    ...
    expect(
      find.text('Choose how you are using the app right now.'),
      findsOneWidget,
    );
  });
